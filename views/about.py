...
st.markdown('The whole idea of Cryptic Trainer is for it to serve and nurture the cryptic crrossword community, and so all clues are either written be me (Lewis) or sourced directly from the community through in-app submissions.  \n' \
            'All clues published are therefore written for and written by the same community, and each goes through a review process conducted by me to ensure the clues (and more importantly the explanations of how to solve them) are of the highest quality.  \n' \
